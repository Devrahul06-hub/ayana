...
const projects = [
  ...
  { title: 'Resident Connect', category: 'Community Platform', result: 'Networking platform connecting medical aspirants & residents across India', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=900&q=80', grad: 'linear-gradient(135deg, rgba(6,78,89,0.9) 0%, rgba(8,145,178,0.82) 55%, rgba(20,184,166,0.72) 100%)' },
]
